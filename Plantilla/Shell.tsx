  ...
  return (
    <div className={`min-h-screen ${COLORS.bg} font-sans flex flex-col p-4 md:p-8 animate-in fade-in duration-500`}>
      ...
      <header className="sticky top-0 z-50 bg-white mb-8 border-b border-gray-200 pb-6 pt-4 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black tracking-tighter text-gray-900 flex items-center gap-1">
            <div className="flex items-center">
              <span className="text-gray-400">F</span>
              <ArrowRight className="text-red-700 mx-0.5" size={20} strokeWidth={4} />
              <span className="text-gray-900">D</span>
            </div>
            <span className="ml-2">Finanzas</span>
          </h1>
